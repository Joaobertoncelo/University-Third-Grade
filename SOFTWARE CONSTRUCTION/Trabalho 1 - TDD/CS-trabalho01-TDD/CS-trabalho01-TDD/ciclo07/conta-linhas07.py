...
# 1o passo (red): copie aqui os casos de teste 01 a 06 e escreva o novo caso de teste 		
def test_07():
...
# Caso a resposta seja sim, crie o arquivo conta-linhas07a.py com o código refatorado
