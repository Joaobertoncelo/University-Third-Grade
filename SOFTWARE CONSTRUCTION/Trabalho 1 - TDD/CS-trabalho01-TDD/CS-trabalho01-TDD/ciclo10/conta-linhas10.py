...
# 1o passo (red): copie aqui os casos de teste 01 a 09 e escreva o novo caso de teste 		
def test_10():
	...
	assert conta_linhas("teste9.txt") == 30
	assert conta_linhas("último-ciclo-xx.txt") == 38
...
# Caso a resposta seja sim, crie o arquivo conta-linhas09a.py com o código refatorado
